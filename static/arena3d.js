(() => {
  if (typeof window.THREE === "undefined") {
    console.error("[arena3d] THREE not loaded");
    return;
  }
  ...
  function onPointerDown(e) {
    ...
    // Click empty space: drop selection, but also allow placing selected at clicked point (useful)
  ...
  async function loadStlFile(file) {
    ...
    // Auto-scale: aim ~35 units tall, but keep reasonable range
  ...
  // Expose minimal API for index.html buttons
